...
export const IconCheckFulled = ({ 
   color,
   size = 30 
  }:IconProps): ReactElement => {

  const viewBox = '0 0 191.667 191.667';
  ...
  return (
    <IconStyled size={size}>
      ...
      >
        <PathStyled color={color} d="M95.833,0C42.991,0,0,42.99,0,95.833s42.991,95.834,95.833,95.834s95.833-42.991,95.833-95.834S148.676,0,95.833,0z
